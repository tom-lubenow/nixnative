...
in rec {
  ...
  mkManifest = manifestSpec:
    ...
    else throw "nixnative: dependency manifest must contain a 'units' attribute. Got: ${showValue manifest}. Expected format: { schema = 1; units = { \"src/file.cc\" = { dependencies = [...]; }; }; }";
